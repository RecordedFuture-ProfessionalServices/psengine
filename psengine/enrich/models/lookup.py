...
class CVSSV4(RFBaseModel):
    subsequent_system_integrity: Optional[str] = Field(alias='subsequentSystemIntegrity', default=None)
    ...
    vulnerable_system_confidentiality: Optional[str] = Field(alias='vulnerableSystemConfidentiality', default=None)
    vulnerability_response_effort: Optional[str] = Field(alias='vulnerabilityResponseEffort', default=None)
    threat_score: Optional[float] = Field(alias='threatScore', default=None)
    subsequent_system_availability: Optional[str] = Field(alias='subsequentSystemAvailability', default=None)
    base_severity: Optional[str] = Field(alias='baseSeverity', default=None)
    base_score: Optional[float] = Field(alias='baseScore', default=None)
    user_interaction: Optional[str] = Field(alias='userInteraction', default=None)
    attack_vector: Optional[str] = Field(alias='attackVector', default=None)
    source: Optional[str] = None
    vulnerable_system_integrity: Optional[str] = Field(alias='vulnerableSystemIntegrity', default=None)
    vulnerable_system_availability: Optional[str] = Field(alias='vulnerableSystemAvailability', default=None)
    modified: Optional[datetime] = None
    vector_string: Optional[str] = Field(alias='vectorString', default=None)
    ...
    subsequent_system_confidentiality: Optional[str] = Field(alias='subsequentSystemConfidentiality', default=None)
