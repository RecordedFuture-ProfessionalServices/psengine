...
SUBMISSION_METHOD_API = 'api'
SUBMISSION_METHOD_INTEGRATION = 'integration'
SUBMISSION_METHOD_SANDBOX = 'sandbox'

ATOP_USE_CASE_HUNTING = 'hunting'
ATOP_USE_CASE_DETECTION = 'detection'
ATOP_USE_CASE_PREVENTION = 'prevention'
