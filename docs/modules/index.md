...
Also note that before running any of the examples you need to have a Recorded Future API Token and it must be saved as an environment variable as `RF_TOKEN`. This step is mandatory for PSEngine to interact with the Recorded Future API. 

For example on Linux or MacOS you will do:
