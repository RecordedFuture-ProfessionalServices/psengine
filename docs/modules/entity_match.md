...
Specifying the type of the entity leads to better results. For a complete list of entity types, see [this](https://support.recordedfuture.com/hc/en-us/articles/4408236421267-Entity-Match-API) support article.

## Examples

{! modules/_includes/examples_warning.md !}

#### Find the ID of CVE-2022-0847
...
#### Identify the entity with ID b89Juu and print its name
...
#### Handling entities that are not
