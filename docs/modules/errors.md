...
The first examples show errors as they appear without handling, followed by examples demonstrating proper error handling techniques.

## Examples

{! modules/_includes/examples_warning.md !}

#### Handling missing or wrong token
...
#### Handling missing token permissions
...
#### Understanding `ValidationError` on wrong fields
